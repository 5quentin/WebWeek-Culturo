...
<body>
  ...
  <div class="ticketContainer">
    <div class="desc">
      ...
      <p>55€ : un accès à toutes les zones sauf la zone concert</p>

      <h1 id="vip">VIP Pass ★</h1>
      <p>70€ : accès à toutes les zones + 1 repas + coupe file + place privilégiées</p>

      <h1 id="concert">+10€ pour l'accès à la zone concert</h1>

      <h1 class="europe" id="europe">Découvrer et votez pour les oeuvres des artistes de votre pays <span id="bleu">!</span><br>Les événements en collaboration avec CULTURO <br>sont au prix de <span id="orange">50€</span></h1>
