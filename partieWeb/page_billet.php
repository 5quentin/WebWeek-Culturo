...
<body>
  ...
  <div class="ticketContainer">
    <div class="desc">
      ...
      <p>55€ : access to all areas except concert</p>

      <h1 id="vip">VIP Pass ★</h1>
      <p>70€ : all areas except concert + 1 meal + skip the line + front seats</p>

      <h1 id="concert">+10€ for concert access</h1>

      <h1 class="europe" id="europe">Discover and vote for the works of your country <span id="bleu">!</span><br>Events in collaboration with Culturo <br>will be fixed at <span id="orange">50€</span></h1>
    ...
    <div class="container_billet">
      ...
      <form class="billet" method="POST" action="page_billet.php" enctype="multipart/form-data">
        ...
        <div class="centre">
          ...
          <div class="titre">
            <h2>What formula do you want ? :</h2>
          </div>
